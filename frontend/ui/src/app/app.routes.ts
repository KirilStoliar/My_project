...
export const routes: Routes = [
...

  {
    path: 'orders/:id/pay',
    canMatch: [authCanMatch],
    loadComponent: () => import('./pages/orders/order-pay/order-pay.page').then(m => m.OrderPayPage),
  },

  {
    path: 'payments',
    canMatch: [authCanMatch],
    loadComponent: () => import('./pages/payments/payments-list/payments-list.page').then(m => m.PaymentsListPage),
  },
